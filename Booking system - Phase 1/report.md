# Booking System â€“ Phase 1 â€“ Penetration Testing Report
...
|---|----------------------------------------|--------------|
| 1 | SQL Injection in username field        | í´´ Critical   |
| 2 | Role escalation via `role=admin`       | í´´ Critical   |
| 3 | Server error on invalid role           | í¿  Medium     |
| 4 | Weak error handling                    | í¿¢ Low        |

---

## 3. Detailed Findings

### í´´ 3.1 SQL Injection in Username Field
...
### í¿  3.3 Improper Role Validation (Broken Access Control)
